...
```
index.php index-new.php index-new2.php index-final.php index-final2.php
index-final2-edited.php index-final2.edited.php.bak index-actually-final!.php
```
after a long days work? Tired of FTPing individual files and constantly making
and copying backups by hand? Look no further! With proper version control, those
...
This has gotten quite a bit longer than I originally intended. Look like I'll
